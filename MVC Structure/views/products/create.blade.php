			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group" id="quantity">
								...
								<div class="col-lg-7">
									<input type="number" min="0" value="0" step="1" placeholder="{{__('Minimum Quantity')}}" name="min_stock" class="form-control" required>
								</div>
							</div>
								<div class="form-group" id="quantity">
								<label class="col-lg-2 control-label">{{__('Maximum Quantity')}}</label>
								<div class="col-lg-7">
									<input type="number" min="0" value="0" step="1" placeholder="{{__('Maximum Quantity')}}" name="max_stock" class="form-control" required>
								</div>
							</div>
					<br>
