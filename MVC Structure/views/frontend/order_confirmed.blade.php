                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <table class="details-table table">
                                                ...
                                                <tr>
                                                    <td class="w-50 strong-600">{{translate('Shipping Payment')}}:</td>
                                                    <td>Tk{{$order->shipinout}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="w-50 strong-600">{{translate('Bkash Number')}}:</td>
                                                    <td>+88 {{$order->bksh_num}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="w-50 strong-600">{{translate('Transaction ID')}}:</td>
                                                    <td style="text-transform: uppercase">{{$order->trn_id}}</td>
                                                </tr>
                                                <tr>
