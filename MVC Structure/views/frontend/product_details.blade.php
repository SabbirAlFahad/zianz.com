                        ...
                        <div class="product-description-wrapper">
                            ...
                            <form id="option-choice-form">
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-10">
                                        <div class="product-quantity d-flex align-items-center">
                                            <div class="input-group input-group--style-2 pr-3" style="width: 160px;">
                                                ...
                                                <input type="text" name="quantity" class="form-control input-number text-center" placeholder="1" value="{{ $detailedProduct->min_stock }}" min="{{ $detailedProduct->min_stock }}" max="{{ $detailedProduct->max_stock }}">
                                                <span class="input-group-btn">
                                  ...
                                  <div class="row no-gutters">
                                    <div class="col-4">
                                        <div class="product-description-label mt-2">{{__('Min Quantity')}}:  {{ $detailedProduct->min_stock }}</div>
                                    </div>
                                    <div class="col-4">
                                        <div class="product-description-label mt-2">{{__('Max Quantity')}}:  {{ $detailedProduct->max_stock }}</div>
                                    </div>
                                   
                                </div>
                                   <div class="row no-gutters">
                                    <div class="col-8"> 
                                        <div class="product-description-label mt-2">{{__('Expected delivery Date')}}: <span class="text-success"> {{ Carbon\Carbon::now()->addDays(7)->isoFormat('MMM Do YY') }} to {{ Carbon\Carbon::now()->addDays(14)->isoFormat('MMM Do YY') }}</span></div>
                                    </div>
