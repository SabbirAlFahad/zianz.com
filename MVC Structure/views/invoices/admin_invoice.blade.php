...
<head>
    ...
    <title>Zianz E-tail Market</title>
		...
		<div style="padding: 1.5rem;padding-bottom: 0">
			<table>
				...
				<tr><td class="gry-color small">{{ translate('Phone') }}: {{ $shipping_address->phone }}</td></tr>
					<tr><td class="gry-color small">{{ translate('Shipping Payment') }}: Tk{{$order->shipinout}}</td></tr>
				<tr><td class="gry-color small">{{ translate('Bkash Number') }}: +88 {{$order->bksh_num}}</td></tr>
				<tr><td class="gry-color small" style="text-transform: uppercase">{{ translate('Transaction Number') }}: {{$order->trn_id}}</td></tr>
			</table>
		</div>
