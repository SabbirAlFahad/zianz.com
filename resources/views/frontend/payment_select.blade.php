                            ...
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    @endif
                                                  <div class="row">
                                            <div class="col-xxl-6 col-lg-8 col-md-10 mx-auto">
                                            <div class="col-12 text-center bg-gray py-4">
                                            <i class="fa"></i>
                                            <div class="h5 mb-4">
                         <h6>
Please use following steps to pay shipping charge:</h6>
<p>
Go to bKash Menu by dialing *247#</p><p>
Choose 'Send Money' option by pressing '3'</p><p>
Enter our Personal wallet number : 01311155835</p><p>
Enter BDT. amount you have to pay : xxxx</p><p>
Enter the counter number : 1</p><p>
Now enter your PIN to confirm: xxxx</p><p>
Done! You will get a confirmation SMS</p><p>
Enter your bKash wallet/ contact number and transaction ID in the below form and submit.</p>
    <p>
    Note: Shipping charge will not returned if you cancelled the product.</p>                                        </div>
                                            <div class="form-group">
    <select name="shippinginout" class="form-control" >
       
      <option value="70">Inside Dhaka TK70</option>
      <option value="100">Outside Dhaka TK100</option>

    </select>
  </div>
                      <div class="form-group">
                                
                              <input type="text" style="text-transform: uppercase"  id="trn_id" name="trn_id" class="form-control" placeholder="{{__('Transaction ID')}}" required>
                                  
                               
                         </div>     
                         <div class="form-group">
                                
                                  <input type="tel" name="bksh_num" id="bksh_num" class="form-control" placeholder="{{__('Bkash Number')}}" required>
...
@section('script')
    <script type="text/javascript">
        ...
        function submitOrder(el){
            ...
            if($('#agree_checkbox').is(":checked")){
              var value = document.getElementById('bksh_num').value;
                if (value.length <= 9) {
                      showFrontendAlert('error','{{ translate('You need to Enter Correct Bkash Number') }}');
                      $(el).prop('disabled', false);
 } else {
       var value = document.getElementById('trn_id').value;
                if (value.length <= 9) {
                      showFrontendAlert('error','{{ translate('You need to Enter Correct Tranaction Number') }}');
                      $(el).prop('disabled', false);
 } else {
       $('#checkout-form').submit(); 
 }
