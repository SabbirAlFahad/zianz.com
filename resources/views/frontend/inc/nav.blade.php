<div class="header bg-white">
                            ...
                            <div class="search-box flex-grow-1 px-4">
                                <form action="{{ route('search') }}" method="GET">
                                    <div class="d-flex position-relative">
                                        ...
                                        <div class="w-100">
                                            <input type="text" aria-label="Search" id="search" name="q" class="w-100" placeholder="{{translate('Search for...')}}" autocomplete="off">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item ">
        <a class="nav-link mt-0" href="#">All Shops</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link mt-0" href="#">Gift Card</a>
      </li>
     
      <li class="nav-item ">
        <a class="nav-link mt-0" href="#">Campaigns</a>
      </li>
    </ul>
 <ul class="navbar-nav ml-auto">
      <li class="nav-item ">
        <a class="nav-link mt-0" href="#">News Feed</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link mt-0" href="#">Merchant Zone</a>
      </li>
     
      <li class="nav-item ">
        <a class="nav-link mt-0" href="#">Help</a>
      </li>
    </ul>
  </div>
